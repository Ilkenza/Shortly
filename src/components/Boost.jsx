function Boost() {
  return (
    <aside className="bg-primary-violet h-[20vh] w-full flex flex-col justify-center items-center">
      <div className="h-[20vh] w-full flex flex-col justify-center items-center gap-5 bg-no-repeat bg-cover lg:bg-bg_boost_desktop bg-bg_boost_mobile bg-[10px_-27px] sm:bg-top">
